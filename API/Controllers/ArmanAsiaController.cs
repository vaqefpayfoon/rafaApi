...
namespace API.Controllers
{
    ...
    public class ArmanAsiaController : ControllerBase
    {
        private readonly IConfiguration _configuration;
        public ArmanAsiaController(IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> GetEmployees()
        {
            ...
            string connectionString = _configuration.GetConnectionString("ArmanAsia");
